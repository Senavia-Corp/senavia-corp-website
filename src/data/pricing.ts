...
export const ECOMMERCE: Pkg[] = [
  {
    ...
    name: 'Starter Store',
    platform: 'Webflow',
    tagline_en: 'Your online store ready to sell in 30 days',
    tagline_es: 'Tu tienda online lista para vender en 30 días',
    ...
    includes: [
      ...
      { en: 'Looks perfect on mobile, where 80% buy', es: 'Se ve perfecta en el celular, donde compra el 80%' },
      { en: 'Take card, PayPal, Apple & Google Pay from day one', es: 'Cobra con tarjeta, PayPal, Apple y Google Pay desde el día 1' },
      { en: 'Customers check out in 2 clicks, no drop-off', es: 'Tus clientes compran en 2 clics, sin abandonar' },
